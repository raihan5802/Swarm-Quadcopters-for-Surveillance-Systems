...
username = 'swarm2'  # HiveMQ Cloud username
password = 'swarm'  # HiveMQ Cloud password

client_id = 'pi2'

# MQTT topics
topic_send = 'drone2/coords'
topic_receive = 'drone1/coords'
...
def on_message(client, userdata, msg):
    ...
    print(f"Received from Pi1: Latitude={lat}, Longitude={lon}")
...
try:
    while True:
        lat = float(input("Enter latitude for Pi2: "))
        lon = float(input("Enter longitude for Pi2: "))
